const Northcoders = () => {
  ...
  if (!words.innerHTML) {
    ...
    heading.innerHTML =
      'Hide Northcoders  <a href="https://northcoders.com/" target="_blank"><img class="footericon" src="https://pbs.twimg.com/profile_images/1333392601450426370/x_DT51WI_400x400.jpg" alt="NC logo" /><a/>';
    words.innerHTML =
...
const Time4Torah = () => {
  ...
  if (!words.innerHTML) {
    heading.style.color = "blue";
    heading.innerHTML =
      'Hide Time4Torah  <a href="http://time4torah.org/" target="_blank"><img class="footericon" src="https://i1.sndcdn.com/avatars-000566284278-uagkxs-original.jpg" alt="T4T" /></a>';
    words.innerHTML =
...
const TheDvashProject = () => {
  ...
  if (!words.innerHTML) {
    heading.style.color = "blue";
    heading.innerHTML =
      'Hide The Dvash Project <a href="http://dvash.org.uk/" target="_blank"><img class="footericon" src="https://dvash.org.uk/wp-content/uploads/2019/09/DVASH-VECTOR.png" alt="dvash" /></a>';
    words.innerHTML =
